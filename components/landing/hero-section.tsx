...
const words = ['virtual', 'tu', 'a la medida', 'tu estilo'];
    ...
    <section className='relative min-h-screen flex flex-col justify-center items-start overflow-hidden bg-black'>
        ...
        <div className='lg:max-w-[55%]'>
          ...
          >
            <span className='inline-flex items-center gap-3 text-sm font-mono text-white/60'>
              ...
              Escaneo corporal con inteligencia artificial
            </span>
          </div>
          ...
          <div className='mb-12'>
            ...
            >
              <span className='block whitespace-nowrap'>Tu vestidor</span>
      ...
      >
        <div className='max-w-[1400px] mx-auto flex items-start gap-10 lg:gap-20'>
          {[
            { value: '30s', label: 'tiempo de escaneo' },
            { value: '99.7%', label: 'precisión de medidas' },
            { value: '3D', label: 'modelo corporal' },
          ].map((stat) => (
