...
export const MOCK_CATALOG: MockGarment[] = [
  {
    ...
    brand: 'NORDIST',
    category: 'top',
    imageUrl: 'https://picsum.photos/seed/tee-white/400/600',
    sizes: [
  ...
  },
  {
    ...
    brand: 'NORDIST',
    category: 'top',
    imageUrl: 'https://picsum.photos/seed/tee-black/400/600',
    sizes: [
    ...
    color: 'Negro',
    material: '95% Algodon, 5% Elastano',
    price: 34.90,
  },
  {
    id: '3',
    ...
    brand: 'STREETFIT',
    category: 'top',
    imageUrl: 'https://picsum.photos/seed/top-blue/400/600',
    sizes: [
  ...
  },
  {
    ...
    brand: 'LINEN&CO',
    category: 'top',
    imageUrl: 'https://picsum.photos/seed/shirt-beige/400/600',
    sizes: [
  ...
  },
  {
    ...
    brand: 'DENIMLAB',
    category: 'bottom',
    imageUrl: 'https://picsum.photos/seed/jeans-dark/400/600',
    sizes: [
  ...
  },
  {
    ...
    brand: 'URBANOUT',
    category: 'bottom',
    imageUrl: 'https://picsum.photos/seed/cargo-green/400/600',
    sizes: [
  ...
  },
  {
    ...
    brand: 'MINIMAL',
    category: 'bottom',
    imageUrl: 'https://picsum.photos/seed/skirt-black/400/600',
    sizes: [
    ...
    color: 'Negro',
    material: '97% Algodon, 3% Elastano',
    price: 49.90,
  },
  {
    id: '8',
    ...
    brand: 'SLEEPWEAR',
    category: 'dress',
    imageUrl: 'https://picsum.photos/seed/dress-gray/400/600',
    sizes: [
  ...
  },
  {
    ...
    brand: 'BOTANICA',
    category: 'dress',
    imageUrl: 'https://picsum.photos/seed/dress-floral/400/600',
    sizes: [
  ...
  },
  {
    ...
    brand: 'BASIC',
    category: 'dress',
    imageUrl: 'https://picsum.photos/seed/dress-black/400/600',
    sizes: [
    ...
    color: 'Negro',
    material: '92% Algodon, 8% Elastano',
    price: 44.90,
  },
  {
    id: '11',
    name: 'Chaqueta Denim Clasica',
    brand: 'DENIMLAB',
    category: 'outerwear',
    imageUrl: 'https://picsum.photos/seed/jacket-denim/400/600',
    sizes: [
    ...
    color: 'Azul Denim',
    material: '100% Algodon Denim',
    price: 119.90,
  },
  {
    id: '12',
    name: 'Blazer Structure Negro',
    brand: 'OFFICE',
    category: 'outerwear',
    imageUrl: 'https://picsum.photos/seed/blazer-black/400/600',
    sizes: [
